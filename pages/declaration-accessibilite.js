...
const Accessibilite = () => (
  <Page title='Déclaration d’accessibilité' description='Consultez la déclaration d’accessibilité de pcrs.beta.gouv'>
    <section className='fr-py-10w fr-px-15w'>
      <h1>Déclaration d’accessibilité</h1>
      <div className='illustration-wrapper fr-pb-10w fr-pt-5w'>
    ...
    <section className='fr-py-10w fr-px-15w section-color'>
    ...
    <section className='fr-py-10w fr-px-15w section-secondary'>
    ...
    <section className='fr-py-10w fr-px-15w'>
      ...
      <ul className='fr-p-3w'>
        <li className='fr-p-1w'><span className='fr-icon-arrow-right-s-line' aria-hidden='true' />Écrire un message au <b>Défenseur des droits.</b></li>
        <li className='fr-p-1w'><span className='fr-icon-arrow-right-s-line' aria-hidden='true' />Contacter <b>le délégué du Défenseur des droits</b> dans votre région.</li>
        <li className='fr-p-1w'><span className='fr-icon-arrow-right-s-line' aria-hidden='true' />
          Envoyer un courrier par la poste (gratuit, ne pas mettre de timbre).<br />
          <b className='fr-p-3w'>Défenseur des droits</b><br />
          <b className='fr-p-3w'>Libre réponse 71120</b><br />
          <b className='fr-p-3w'>75342 Paris CEDEX 07</b>
        </li>
      </ul>
      <div />
    </section>
