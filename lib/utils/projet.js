...
export const STOCKAGE_PARAMS = {
  host: {label: 'Adresse du serveur', defaultValue: 'Non renseigné'},
  username: {label: 'Identifiant', defaultValue: 'Non renseigné'},
  password: {label: 'Mot de passe', defaultValue: 'Non renseigné'},
  startPath: {label: 'Chemin du répertoire', defaultValue: '/ (défaut'},
  port: {label: 'Port', defaultValue: 'Non renseigné'}
}
