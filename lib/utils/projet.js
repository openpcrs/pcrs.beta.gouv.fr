...
export const LIVRABLE_NATURES = {
  geotiff: {label: 'Livrable GeoTIFF', color: '#f7b39e'},
  jpeg2000: {label: 'Livrable Jpeg 2000', color: '#87bbed'},
  gml: {label: 'Livrable GML vecteur', color: '#f9b8f5'}
}
...
export const DIFFUSIONS = {
  wms: {label: 'Diffusion via un service WMS'},
  wmts: {label: 'Diffusion via un service WMTS'},
  tms: {label: 'Diffusion via un service TMS'}
}
